...
export class MailDecoder {
  static decode(rawData: string): Transaction | null {
  ...
  static decodeCardPaymentData(rawData: string): Transaction {
  ...
  static decodeTransferData(rawData: string): Transaction {
